      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            ...
            <p class="large">Find various events and opportunities to learn and network
              </p>
          </div>
        </div>
      </div>
     ...
     while ($row = mysqli_fetch_array($events_per_page)){
       ?>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 about_cont_blog">
          ...
          <div class="full text_align_center">
          <button class="btn main_bt partner" onclick="document.getElementById('id01').style.display='block'" >Register</button>
          </div>
          
        </div>
      </div>
      <br><br>
      <!-- Confirmation box to Register -->
      <div id="id01" class="modal" style="width: 40%; margin: auto;">
        ...
        <div class="full text_align_center" style=" background-color: grey; height: auto;  ">
            ...
            <h5>Register for <?php echo $row['Title']; ?></h5>
            <br><br>
              ...
              <a href="eventRegistration.php?EventID=<?php echo $row['EventID']; ?>" ><button style="width:50%; height: 40px; color: white; background-color: black;" >Register</button></a>
        </div>
      </div>
      <?php
     }
...
if($allEvents){
  ...
  for($b = 1; $b <=$per_page; $b++){
      ?> <a style='font-size: 30px;color: white;'href="viewEvents.php?page=<?php echo $b; ?>">
