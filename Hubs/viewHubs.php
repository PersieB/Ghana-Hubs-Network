  ...
  <div class="header_bottom">
    <div class="container">
      <div class="row">
        ...
        <?php
        /* include navbar based on user */
        if(isset($_SESSION['ChairID'])){
          include "../Chairperson/hubNavbar.html";
        }

        else{
          include "../generalPublic/hubNavbar.html";
        }
        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              ...
              <ol class="breadcrumb">
                <li>Our Hubs</li>
                <li class="active"><a <?php if(isset($_SESSION['UserID'])){
                  echo "href='../generalPublic/logout.php'";
                }else if(isset($_SESSION['ChairID'])){
                  echo "href='../Chairperson/logout.php'";
                } ?>>Logout</a></li>
              </ol>
            </div>
          </div>
       ...
       ?>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 about_cont_blog">
          ...
          <div class="full text_align_center">
            ...
            <span><?php echo "<a class='btn main_bt' href='$site' target='_blank'>Find out more</a>"; ?></span>
            <button class="btn main_bt partner" onclick="document.getElementById('id01').style.display='block'" >Partner</button>
          </div>
          
        </div>
      </div>
      <br><br>
      <!-- Confirmation box for Partnership -->
      <div id="id01" class="modal" style="width: 40%; margin: auto;">
        
        <div class="full text_align_center" style=" background-color: grey; height: auto;  ">
        
            <h5>Confirm partnership with <?php echo $row['Company_name']; ?></h5>
            <br><br>
              ...
              <a href="individualPartner.php?HubID=<?php echo $row['HubID']; ?>" ><button style="width:50%; height: 40px; color: white; background-color: black;" >Partner</button></a>
        </div>
      </div>
      <?php
     }
...
if($allHubs){
  ...
  for($b = 1; $b <=$per_page; $b++){
      ?> <a style='font-size: 30px;color: white;'href="viewHubs.php?page=<?php echo $b; ?>">
