...
$addHub = new CRUD();   //CRUD object
$validation = new HubEventMeet();    //HubEventMeet object

if(isset($_POST['add'])){      //check if form has been submitted
  /* Get form data */
  ...
  /* Perform backend validation */
    ...
    else{    //no error in form submission
      $newHub = $addHub->addHub($hubName, $address, $telephone, $gmail, $website, $description, $logo);   //add hub
      if($newHub){    //addition successful
        echo "<script> alert('NEW MEMBER ADDED!');
        window.location.href='viewHubs.php';</script>";
      }else{
        echo "<script> alert('NEW MEMBER UNSUCCESSFUL!');
              </script>";
      }
    }
  ...
  <div class="header_bottom">
    <div class="container">
      <div class="row">
        ...
        <?php 
        include "../Chairperson/hubNavbar.html" // chairperson navbar?>
      </div>
    </div>
  </div>
  <!-- header bottom end -->
